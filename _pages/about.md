...
I'm Badhan Chandra Das, PhD candidate at Knight Foundation School of Computing and Information Sciences (KFSCIS), Florida International University. My research is primarily focused on the privacy and security of AI, federated learning, computer vision, large language models, vision language models, and their real-world applications. I am also a Graduate Research Assistant (GRA) at the Security, Optimization, and Learning for InterDependent Networks Laboratory (solid lab), FIU and served as Graduate Teaching Assistant (GTA) at KFSCIS, FIU. Before joining FIU, I served as a lecturer in Computer Science department at Bangladesh University of Business and Technology (BUBT), Bangladesh. I graduated in Computer Science and Engineering from Jahangirnagar University, Bangladesh, and completed my MS in the same discipline from the same department. Apart from my academics and profession, I love reading books, traveling, and exploring new things.
...
* **Das, Badhan Chandra**, Yanzhao Wu, and M. Hadi Amini. "_An accurate and efficient two-stage framework for gun detection in videos_." Engineering Applications of Artificial Intelligence, Elsevier (accepted).
* **Das, Badhan Chandra**, Tasnim Jawad, Md Jueal Mia, M. Hadi Amini, and Yanzhao Wu. "_Jailbreaking large vision language models in intelligent transportation systems_." In IEEE International Conference on Machine Learning and Applications (ICMLA), 2025.
...
* **Das, Badhan Chandra**, M. Hadi Amini, and Yanzhao Wu. "_In-depth Analysis of Privacy Threats in Federated Learning for Medical Data_." arXiv preprint arXiv:2409.18907 (2024); journal version under review, IEEE Journal of Biomedical and Health Informatics (J-BHI).
...
* **Graduate Teaching Assistant, KFSCIS, FIU**
  * Introduction to Artificial Intelligence (Spring 2025, Spring 2026)
...
* **Course Support (GTA), Break Through Tech / Cornell University**
  *  Foundations of Machine Learning (Summer 2026)
* **Curriculum Development**
  * Developed and launched the FIU micro-credential "Artificial Intelligence in Crime Analysis and Detection," supported by DHS CINA (Summer 2025)
* **Guest Lectures**
  *  Foundation of Machine Learning, Break Through Tech (Summer-2025)
  *  Introduction to Artificial Intelligence, FIU (Spring-2025, Fall-2025)
...
* **Best Poster Award [3rd place], Graduate Student Appreciation Week, FIU** [2025]
* **Student Travel Grant:** NSF travel grant for International Conference on Bioinformatics and Biomedicine [BIBM-2023]
* **Conference Travel Grant:** From Graduate and Professional Student Committee (GPSC) at FIU [2023, 2025]
